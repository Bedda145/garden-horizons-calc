...
import { 
  ...
  MountainSnow, Tornado, Wind, 
  Zap, Droplets, Star, Sparkles, Leaf 
} from 'lucide-react';
...
export const mutationsData: Mutation[] = [
  ...
  { id: 'mossy', name: 'Mossy', multiplier: 3.5, icon: Leaf }, // Adjust these as you see fit!
  { id: 'shocked', name: 'Shocked', multiplier: 4.5, icon: Zap },
  { id: 'muddy', name: 'Muddy', multiplier: 5.0, icon: Droplets }, // Example
